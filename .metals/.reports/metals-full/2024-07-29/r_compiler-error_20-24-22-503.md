...
parent      = new APBBundle(APBBundleParameters(addrBits = null)) # -1,
parent span = <1941..2115>,
child       = APBBundleParameters(addrBits = null) # -1,
child span  = [1955..1974..2118]
...
class APBSPI(address: Seq[AddressSet])(implicit p: Parameters)
  ...
  class Impl extends LazyModuleImp(this) {
    ...
    val xip_out= (new APBBundle(APBBundleParameters(addrBits = 
    val send_data= null
    mspi.io.clock := clock
    mspi.io.reset := reset
    mspi.io.in <> in
